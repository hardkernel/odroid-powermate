...
const static char* keys[NCONFIG_TYPE_MAX] = {
    ...
    [VIN_CRITICAL_CURRENT_LIMIT] = "vin_cclimit",
    [MAIN_CRITICAL_CURRENT_LIMIT] = "main_cclimit",
    [USB_CRITICAL_CURRENT_LIMIT] = "usb_cclimit",
...
struct default_value const default_values[] = {
    ...
    {VIN_CRITICAL_CURRENT_LIMIT, "15.0"},
    {MAIN_CRITICAL_CURRENT_LIMIT, "11.0"},
    {USB_CRITICAL_CURRENT_LIMIT, "6.0"},
    {PAGE_USERNAME, "admin"},
    {PAGE_PASSWORD, "password"},
